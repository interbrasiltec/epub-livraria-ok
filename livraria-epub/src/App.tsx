        ...
        <header className="h-16 border-b border-gray-800 flex items-center justify-between px-6 bg-bg-header shrink-0">
          <div className="flex gap-4 items-center flex-1">
            ...
            >
              <button 
                type="submit"
                className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-sky-400 p-1 rounded transition-colors cursor-pointer flex items-center justify-center outline-none"
                title="Pesquisar"
              >
                <Search size={16} />
              </button>
              <input 
                ...
                className="bg-gray-800 border-none rounded-lg py-2 pl-10 pr-10 text-xs w-full focus:ring-1 focus:ring-accent-blue transition-all"
              />
              {tempSearchQuery && (
                <button
                  type="button"
